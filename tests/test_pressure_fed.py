...
PROPULSION_SYSTEM = PropulsionSystem(
    tank=PROP_TANK,
    inlet_pressure=Q_(20.0,'bar'),
    specific_impulse=Q_(310.0,'sec'),
    thrust=Q_(10.0,'kN'),
    mass_scalar=Q_(0.002,'kg/bar'),
